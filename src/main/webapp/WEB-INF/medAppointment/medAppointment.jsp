	...
	<div class="boxed-page">
				...
				<div class="collapse navbar-collapse" id="navbar-nav-header">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="../report/report.jsp">Make a report</a></li>
						<li class="nav-item"><a class="nav-link"
							href="../doctor/doctor.jsp">Back to doctor page</a></li>
						<li class="nav-item"><a class="nav-link"
							href="../patient/patient.jsp">Back to patient page</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="jumbotron d-flex align-items-center"
			...
			<div class="container text-center">
				<h1 class="display-2 mb-4 single-blog-title">Medical
					appointments</h1>
			</div>
		</div>
					...
					<div class="col-md-8 offset-md-2 mt-4">
						<div class="col-md-12 form-btn text-center">
							<div class="col-md-8 offset-md-2 mt-4">
								<div class="col-md-12 form-btn text-center">
									<h4>Citas médicas</h4>
									<p>Muestra los datos de las citas del doctor</p>
								</div>
							</div>
							...
							<br>
							<h4>Crear un informe médico</h4>
						</div>
						<div class="col-md-12 form-btn text-center">
							<button class="btn btn-block btn-secondary btn-red"
								onclick="location.href='../report/report.jsp'" type="button">Crear
								un informe</button>
